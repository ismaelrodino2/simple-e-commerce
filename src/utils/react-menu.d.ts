...
interface RootMenuProps
  extends BaseMenuProps,
    Omit<MenuStateOptions, "initialOpen"> {
  /**
...
export interface MenuItemProps
  extends Omit<BaseProps<MenuItemModifiers>, "onClick">,
    Hoverable {
  /**
...
export interface FocusableItemProps
  extends BaseProps<FocusableItemModifiers>,
    Hoverable {
  /**
...
type ToggleEvent = (
  open: boolean,
  event: Parameters<React.MouseEventHandler>[0],
) => void;
